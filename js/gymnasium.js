...
class Gymnasium {
  ...
  exam() {
    ...
    if (typeof examProblem !== 'undefined' && examProblem !== null) {
      console.log('[gym exam] exam function active');
      ...
      var show_problem_progress = function(){
        ...
        if (score >= passingScore) {
          console.log('[gym exam] exam passed, submitting to accredible');
          ...
          console.log('[gym exam] exam failed. attempts remaining: ', attempts_remaining);
      ...
      if ($('.problem-header').text().trim() === "Final Exam") {
        console.log('[gym exam] Final Exam');
        let observer = new MutationObserver(mutationRecords => {
          // reset interval if we detect a grade change
          console.log('[gym exam] mutation records: ', mutationRecords);
      ...
      console.warn('[gym exam] exam not active');
    }
  }
