...
[This is the project on CodePen](https://codepen.io/josborn/pen/bydwJo){: target=”_blank” rel=”noopener”} you’ll be working with. And my workspace, well, it looks a little different because I’m using the DuoTone Dark theme, which our mean daddy-o at CodePen, Chris Coyier, has conveniently added for us. So thank you, Chris. And [here is the URL](https://codepen.io/josborn/pen/bydwJo){: target=”_blank” rel=”noopener”} so you can follow along. You can also find the project link in the Resources section for this video.
...
Thanks for watching. If you like this video and want to learn more, well, [check out our other Take 5 videos]((https://thegymnasium.com/take5) as well as [the rest of our gig at Gymnasium](https://thegymnasium.com/courses)
